...
async function createCourse(req, res) {
    ...
    return res.send({ success: true, message: "Course Created Successfully", courseData: newCourseData });
}
...
async function updateCourse(req, res) {
    ...
    const updatedCourseData = await Course.findByIdAndUpdate(courseId, { ...courseData, thumbnail, trailerVideo });
    res.send({ success: true, message: "Course Updated Successfully", updatedCourseData });
}
